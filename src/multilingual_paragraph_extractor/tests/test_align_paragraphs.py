...
class TestAlignParagraphs(TestCase):
    ...
    def test_two_different_pdfs(self):
        ...
        self.assertEqual("English text", paragraphs_from_languages[0].paragraphs[0].original_text)
        self.assertEqual("English text too", paragraphs_from_languages[0].paragraphs[1].original_text)

        self.assertEqual("", paragraphs_from_languages[1].paragraphs[0].original_text)
        self.assertEqual("", paragraphs_from_languages[1].paragraphs[1].original_text)
