...
MARKER_JSONS_PATH = Path("/path/to/marker/jsons")


MARKER_TYPE_TO_TOKEN_TYPE = {
    "Line": TokenType.TEXT,
    "Span": TokenType.TEXT,
    "FigureGroup": TokenType.PICTURE,
    "TableGroup": TokenType.TABLE,
    "ListGroup": TokenType.LIST_ITEM,
    "PictureGroup": TokenType.PICTURE,
    "Page": TokenType.TEXT,
    "Caption": TokenType.CAPTION,
    "Code": TokenType.TEXT,
    "Figure": TokenType.PICTURE,
    "Footnote": TokenType.FOOTNOTE,
    "Form": TokenType.TEXT,
    "Equation": TokenType.FORMULA,
    "Handwriting": TokenType.TEXT,
    "TextInlineMath": TokenType.TEXT,
    "ListItem": TokenType.LIST_ITEM,
    "PageFooter": TokenType.PAGE_FOOTER,
    "PageHeader": TokenType.PAGE_HEADER,
    "Picture": TokenType.PICTURE,
    "SectionHeader": TokenType.SECTION_HEADER,
    "Table": TokenType.TABLE,
    "Text": TokenType.TEXT,
    "TableOfContents": TokenType.TABLE,
    "Document": TokenType.TEXT,
    "ComplexRegion": TokenType.TEXT,
    "TableCell": TokenType.TABLE,
...
def get_xml_segment_boxes(pdf_path: Path) -> list[SegmentBox]:
    ...
    json_path = Path(MARKER_JSONS_PATH, pdf_path.name.replace(".pdf", ".json"))
        ...
        for label in page["page_labels"]:
            xml_segment_boxes.append(
                SegmentBox(
                    ...
                    segment_type=TokenType(MARKER_TYPE_TO_TOKEN_TYPE[label["segment_type"]]),
                )
            )
