...
from trainable_entity_extractor.adapters.extractors.text_to_text_extractor.methods.Ollama.OllamaRun import (
    OllamaRun,
    CODE_FILE_NAME,
)


class OllamaRunMultiOption(OllamaRun):
    options: list[str] = []
    ...
    def _update_data_from_previous_run(self, previous_run: "OllamaRunMultiOption" = None):
    ...
    def from_extractor_identifier_multioption(
        ...
        return OllamaRunMultiOption(code=code, options=[option.label for option in options], multi_value=multi_value)
