...
class NoSpacesRegexMethod(ToTextExtractorMethod):
    ...
    def train(self, extraction_data: ExtractionData):
        ...
        samples_without_spaces = [sample for sample in samples if " " not in sample]
        if len(samples) != len(samples_without_spaces):
            return
