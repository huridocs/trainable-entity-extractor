...
class TestExtractorPdfToMultiOption(TestCase):
    def test_get_pdf_multi_option_suggestions(self):
        ...
        segment_text = "<p>A</p><p>United Nations</p><p>/INF/76/1</p><p>General Assembly</p><p>Distr.: General</p><p>15 February 2021</p><p>Original: English</p><p>Seventy-sixth session</p><p>Opening dates of forthcoming regular sessions of the</p><p>General Assembly and of the general debate</p><p>Note by the Secretariat</p><p>1.</p><p>In paragraph 1 of its resolution</p><p>57/301</p><p>, the General Assembly decided to amend</p><p>rule 1 of its rules of procedure to read: “The General Assembly shall meet every year</p><p>in regular session commencing on the Tuesday of the third week in September,</p><p>counting from the first week that contains at least one working day.” In paragraph 2</p><p>of the resolution, the Assembly also decided that the general debate in the Assembly</p>"
