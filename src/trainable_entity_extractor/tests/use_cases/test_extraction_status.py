...
from trainable_entity_extractor.domain.ExtractionIdentifier import (
...
class TestExtractionStatus(TestCase):
    ...
    def test_no_model(self):
        extraction_identifier = ExtractionIdentifier(run_name="unit_test", extraction_name="extraction_status_extractor")
