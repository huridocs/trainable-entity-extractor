...
class TestPdfToMultiOptionExtractorDistributedTasks(TestCase):
    def setUp(self):
    ...
    def test_get_distributed_tasks_with_empty_options(self):
        extraction_data = self.create_sample_extraction_data()
    ...
    def test_get_distributed_tasks_includes_expected_method_types(self):
        extraction_data = self.create_sample_extraction_data()
    ...
    def test_get_distributed_tasks_with_different_languages(self):
        extraction_data = self.create_sample_extraction_data()
