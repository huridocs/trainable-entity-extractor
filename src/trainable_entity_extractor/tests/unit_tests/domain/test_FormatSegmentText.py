...
class TestFormatSegmentText(TestCase):
    ...
    def test_multiple_texts_no_label(self):
        ...
        self.assertEqual(
            result,
            '<p class="ix_paragraph">First text</p><p class="ix_paragraph">Second text</p><p class="ix_paragraph">Third text</p>',
        )
        self.assertNotIn('<span class="ix_match">', result)
    ...
    def test_empty_strings_in_list(self):
        ...
        result = formatter.get_text()
        self.assertEqual(
            '<p class="ix_matching_paragraph">First <span class="ix_match">text</span></p><p class="ix_adjacent_paragraph"></p><p class="ix_matching_paragraph">Third <span class="ix_match">text</span></p>',
            result,
        )
    ...
    def test_shorter_segment_text(self):
        ...
        result = formatter.get_text()
        self.assertEqual(
            '<p class="ix_adjacent_paragraph">3</p><p class="ix_matching_paragraph"><span class="ix_match">Text</span> appearance</p><p class="ix_adjacent_paragraph">4</p>',
            result,
        )
