...
class TestTextOllamaMultiOption(TestCase):
    @unittest.skip("Requires real Ollama API key")
    def test_text_ollama_multi_option(self):
        extraction_identifier = ExtractionIdentifier(run_name="unit_test", extraction_name="ollama_multi_option_countries")
        ...
        text_to_multioption = TextOllamaMultiOption(extraction_identifier)
    ...
    @unittest.skip("Requires real Ollama API key")
    def test_text_ollama_multi_option_second(self):
        extraction_identifier = ExtractionIdentifier(run_name="unit_test", extraction_name="ollama_multi_option_fruits")
