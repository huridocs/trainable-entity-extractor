...
from trainable_entity_extractor.use_cases.extractors.pdf_to_multi_option_extractor.filter_segments_methods.CleanBeginningDot500 import (
    CleanBeginningDot500,
)


class CleanBeginningDotDigits500(CleanBeginningDot500):
