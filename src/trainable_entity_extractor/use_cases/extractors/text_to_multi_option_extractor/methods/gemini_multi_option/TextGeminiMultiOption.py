...
class TextGeminiMultiOption(TextToMultiOptionMethod):
    ...
    def train(self, extraction_data: ExtractionData):
        ...
        gemini_runs = [GeminiRunMultiOption(mistakes_samples=gemini_samples, options=options_labels)]
        sizes = [number_of_options, 5 * number_of_options, 10 * number_of_options]
        gemini_runs += [GeminiRunMultiOption(max_training_size=n, options=options_labels) for n in sizes]
