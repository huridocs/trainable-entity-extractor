...
class SegmentFrequent6Words:
    ...
    @staticmethod
    def get_other_segment_features(segment: "SegmentFrequent6Words"):
        if not segment:
            return list(np.zeros(22))
    ...
    @staticmethod
    def from_pdf_features(pdf_features: PdfData) -> list["SegmentFrequent6Words"]:
        ...
        previous_title_segment: Optional[SegmentFrequent6Words] = None
