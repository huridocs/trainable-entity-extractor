...
from trainable_entity_extractor.use_cases.extractors.segment_selector.methods.titles_history.SegmentTitlesHistory import (
    SegmentTitlesHistory,
)
...
class TitlesHistory:
    def __init__(self):
        self.segments: list[SegmentTitlesHistory] = list()
        self.model = None
        self.best_cut = 0
    ...
    def set_segments(self, pdfs_segments: list[PdfData]):
        ...
        for pdf_features in pdfs_segments:
            self.segments.extend(SegmentTitlesHistory.from_pdf_features(pdf_features))
